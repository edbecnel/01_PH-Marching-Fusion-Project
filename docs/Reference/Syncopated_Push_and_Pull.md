[Home](../../README.md) › [Project Index](../../PROJECT_INDEX.md) › [Reference](README.md) › Syncopated Push-and-Pull
...
Text grids in this document use the same symbols as [Accent-Taps](Accent_Taps.md) and [Grid Exercises](Grid_Exercises.md):
...
## Example 1: Straight Pulse (Contrast)
...
## Example 2: Basic Bass Push-and-Pull (8th-Note Canvas)
...
## Example 4: Battery Overlay on Push-and-Pull Bass
...
Feel:   Bass leads push-and-pull; snare reinforces offbeat push without straightening the groove
```
...
## Example 6: Straight vs. Push-and-Pull (A/B Listening)
...
| **Creeping taps** | Pull partials grow loud; groove flattens | [Accent-Taps](Accent_Taps.md) height control |
