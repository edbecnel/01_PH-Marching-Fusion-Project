[Home](../../README.md) › [Project Index](../../PROJECT_INDEX.md) › [Reference](README.md) › Philippine Percussion Sound Model

# Philippine Percussion Sound Model

> **Status:** Draft
> **Owner:** Philippine Marching Percussion Fusion Project
> **Applies To:** Arranging, education, ensemble evaluation, and pilot validation
...
This document defines what makes the ensemble sound **immediately recognizable as Filipino** in the Philippine Marching Percussion Fusion style. It describes sonic characteristics—not cultural identity statements (see [Identity Framework](../Specifications/Philippine_Marching_Percussion_Identity_Framework.md)).

Use this model to:

- evaluate whether warm-ups, cadences, and show material sound like the project intends;
- guide arrangers writing in the [Arranging Guide](../User_Guides/Arranging_Guide.md);
...
Pilot validation is ongoing. Refinements from [Indigenous Philippine Percussion](../Research/Indigenous_Philippine_Percussion.md) research and MONHS field work may update this document.
...
## Sonic Identity Summary

A recognizably Filipino fusion battery should present:

- **Festival-forward groove** — danceable momentum and [syncopated push-and-pull](Syncopated_Push_and_Pull.md), not straight military pulse as default
...
- Density that forces players to sacrifice tap height control (see [Accent-Taps](Accent_Taps.md))
...
Regional accent placement (Visayan festival push, Mindanao/Bukidnon festival character, Drum & Lyre street groove) may color the groove. Name the regional inspiration in arrangement notes when used—see [Grid Exercises](Grid_Exercises.md).
...
### Height hierarchy (default training targets)
...
See [Accent-Taps](Accent_Taps.md) and [Legato Stroke](Legato_Stroke.md).

### Accent placement

- Festival-derived **offbeat and displaced accents** are preferred canvas
- Accents should reinforce **native syncopation** and [push-and-pull](Syncopated_Push_and_Pull.md), not fight it
- Grid and warm-up systems ([Grid Exercises](Grid_Exercises.md), [8-8-16 Exercise](Eight_Eight_Sixteen.md)) train accent mobility across all partials
...
### School-context realism

Balance targets must remain achievable for mixed reading levels and local instrumentation—see [Design Principles](../Specifications/Design_Principles.md).
...
### Recommended architecture (proof-of-concept and beyond)
...
Record observations in the [Project Journal](../Development/Project_Journal.md). Confirmed findings update this document and may migrate to the [Concept Library](Concept_Library.md).

## Relationship to Other Documents

| Document | Role |
|---|---|
| [Identity Framework](../Specifications/Philippine_Marching_Percussion_Identity_Framework.md) | Why the style exists and what it must preserve |
| [Design Principles](../Specifications/Design_Principles.md) | How identity influences practice |
| Philippine Percussion Sound Model | What the ensemble should sound like |
| [Arranging Guide](../User_Guides/Arranging_Guide.md) | How to write music that achieves the sound model |
| [Grid Exercises](Grid_Exercises.md) | Training tools that reinforce accent and groove targets |
| [Syncopated Push-and-Pull](Syncopated_Push_and_Pull.md) | Definition and notation examples for festival push-and-pull |
| [Indigenous Philippine Percussion](../Research/Indigenous_Philippine_Percussion.md) | Research backing for collective groove and phrase values |
...
- [Eight_Eight_Sixteen](Eight_Eight_Sixteen.md)
