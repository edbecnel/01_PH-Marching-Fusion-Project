...
> Authoritative navigation hub for the Philippine Marching Percussion Fusion Project.
...
These domains are retained for EDF structural compliance and are not active for this project:

- [API](docs/API/README.md) — not applicable
- [Database](docs/Database/README.md) — not applicable
- [Deployment](docs/Deployment/README.md) — not applicable
...
## Musical Deliverables

- [Scores](scores/README.md)
  - [Technique and Warm-ups](scores/technique-and-warmups/README.md)
  - [Cadences](scores/cadences/README.md)
  - [Show Arrangements](scores/show-arrangements/README.md)
- [Audio](audio/README.md)
  - [Full Mixes](audio/full-mixes/README.md)
  - [Battery Splits](audio/battery-splits/README.md)
